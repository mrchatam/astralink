...
type ServerConfig struct {
	...
	AuthorityPeers                    []string `toml:"AUTHORITY_PEERS"`
	AnycastEnabled                    bool     `toml:"ANYCAST_ENABLED"`
	TransportAware                    bool     `toml:"TRANSPORT_AWARE"`
	TransportFECEnabled               bool     `toml:"TRANSPORT_FEC_ENABLED"`
	TransportFECDataShards            int      `toml:"TRANSPORT_FEC_DATA_SHARDS"`
...
func defaultServerConfig() ServerConfig {
	return ServerConfig{
		...
		Domain:                            nil,
		TransportAware:                    true,
		TransportFECEnabled:               false,
		TransportFECDataShards:            4,
		MinVPNLabelLength:                 3,
